CLASS /dmo/cx_flight_legacy19 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_19',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_19',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id19 OPTIONAL
        booking_id            TYPE /dmo/booking_id19 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id19 OPTIONAL
        agency_id             TYPE /dmo/agency_id19 OPTIONAL
        customer_id           TYPE /dmo/customer_id19 OPTIONAL
        carrier_id            TYPE /dmo/carrier19-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_19-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_19-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date19 OPTIONAL
        end_date              TYPE /dmo/end_date19 OPTIONAL
        booking_date          TYPE /dmo/booking_date19 OPTIONAL
        flight_date           TYPE /dmo/flight_date19 OPTIONAL
        status                TYPE /dmo/travel_status19 OPTIONAL
        currency_code         TYPE /dmo/currency_code19 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id19,
          mv_booking_id            TYPE /dmo/booking_id19,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id19,
          mv_agency_id             TYPE /dmo/agency_id19,
          mv_customer_id           TYPE /dmo/customer_id19,
          mv_carrier_id            TYPE /dmo/carrier19-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_19-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_19-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date19,
          mv_end_date              TYPE /dmo/end_date19,
          mv_booking_date          TYPE /dmo/booking_date19,
          mv_flight_date           TYPE /dmo/flight_date19,
          mv_status                TYPE /dmo/travel_status19,
          mv_currency_code         TYPE /dmo/currency_code19,
...
CLASS /dmo/cx_flight_legacy19 IMPLEMENTATION.
